...
void PwmqThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        PwmqThread *_t = static_cast<PwmqThread *>(_o);
        switch (_id) {
        case 0: _t->start_pid(); break;
        case 1: _t->Manu_PWM(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData PwmqThread::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PwmqThread::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_PwmqThread,
      qt_meta_data_PwmqThread, &staticMetaObjectExtraData }
};
